...
id_patterns = [
    ...
    'plugins*el6', 'focal*64', 'noble*64','suse11.4', 'DOCS', 'kinetic', 'VM',
    'Windows', 'plugins*el8'
]
...
for asset in assets:
    ...
    if info:
        ...
        info['Edge_Cast_Path'] = f"releases/download/community_{TAG.split('_')[1]}/{file_name}"
